...
export default function FirstSection() {
  return (
    <div className="min-h-screen bg-white text-gray-900 px-4 sm:px-6">      
      <main className="container mx-auto px-4 py-4 max-w-6xl">
        <div className="space-y-16">
          {/* What is Pomodoro Technique */}
            <section className="rounded-2xl p-4 sm:p-6 md:p-9">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-5 text-center text-gray-800">
...
, this technique breaks work into
                ...
                <p className="text-sm sm:text-base text-gray-700 leading-relaxed tracking-wide">
                  At FocusNest, we&apos;ve modernized this proven method into a simple, easy-to-use digital tool that helps you stay disciplined, track your sessions, and improve your productivity seamlessly.
          ...
          {/* The Science Behind Pomodoro */}
            <section className="bg-white p-5 sm:p-8 md:p-10 -mt-20">
            <h2 className="text-2xl sm:text-3xl font-bold mb-6 sm:mb-9 text-center text-gray-800">
              The Science Behind the Pomodoro Technique
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 max-w-5xl mx-auto">
              <div className="bg-gray-50 rounded-xl p-4 sm:p-6 shadow flex flex-col">
          ...
          {/* Benefits */}
            ...
            <h2 className="text-2xl sm:text-3xl font-bold mb-10 text-center text-blue-600">
              Why Use the Pomodoro Technique?
            </h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-8">
              <div className="rounded-xl p-4 text-center shadow flex flex-col items-center bg-white/80">
